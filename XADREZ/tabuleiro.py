...
class Tabuleiro:
    ...
    def inicializaMatriz(self):
        ...
        peaoP1 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"),1,0)
        peaoP2 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"), 1, 1)
        peaoP3 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"), 1, 2)
        peaoP4 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"), 1, 3)
        peaoP5 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"), 1, 4)
        peaoP6 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"), 1, 5)
        peaoP7 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"), 1, 6)
        peaoP8 = Peca("torre", "preto", Sprite("Sprites/peaoP.png"), 1, 7)
